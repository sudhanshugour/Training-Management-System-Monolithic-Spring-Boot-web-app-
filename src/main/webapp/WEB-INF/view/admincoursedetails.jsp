...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<f:form action="updateform" modelAttribute="course">
			<table style="padding-left: 5%;">
				...
				<tr>
					...
					<td style="padding-left: 5%;">${xyz.feedbackQue}</td>
				</tr>
		...
		<%--<form action="updateCourse" style="padding-left: 5%;">
		<input type="hidden" name="courseId" value="${courseId}"/>
			<button type="submit" name="update" value="edit"
				class="w3-button w3-white w3-padding-large" style="width: 15%;">
				<b>Edit</b>
			</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

			<button type="submit" name="update" value="delete"
				class="w3-button w3-white w3-padding-large" style="width: 15%;">
				<b>Delete</b>
			</button>
		</form> --%>
			...
			<div class="w3-half" style="padding: 25px 25px 25px 25px;">
				<ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
					...
					<li class="w3-light-grey w3-padding-24">
						<form action="skillOperation">

							<button type="submit" name="skill" value="showQuestions"
								class="w3-button w3-white w3-padding-large" style="width: 40%;">
								<b>Show Questions</b>
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="submit" name="skill" value="showtopics"
								class="w3-button w3-white w3-padding-large" style="width: 40%;">
								<b>Show topics</b>
							</button>
							<br> <br>
							<button type="submit" name="skill" value="addQuestion"
								class="w3-button w3-white w3-padding-large" style="width: 40%;">
								<b>Add Question</b>
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="submit" name="skill" value="addTopic"
								class="w3-button w3-white w3-padding-large" style="width: 40%;">
								<b>Add Topic</b>
							</button>
							<br> <br> <input type="hidden" name="courseId"
								value="${courseId}" /> <input type="hidden" name="skillId"
								value="${skill.skillId}" />
							<button type="submit" name="skill" value="delete"
								class="w3-button w3-white w3-padding-large" style="width: 30%;">
								<b>Delete</b>
							</button>
	...
	<div style="float: left;width: 100%;">
		<a href="updateform?courseId=${xyz.courseId}">
				<button type="submit" name="submit" value="edit"
					class="w3-button w3-white w3-padding-large" style="width: 15%; margin-left: 30%;">
					<b>Edit</b>
				</button>
			</a>
      
      <a href="delete?courseId=${xyz.courseId}">
		...
		<a href="admin_user_feedback?courseId=${xyz.courseId}">
				<button type="submit" name="submit" value="Feedback"
					class="w3-button w3-white w3-padding-large" style="width: 15%;">
					<b>See Feedback</b>
				</button>
			</a>
