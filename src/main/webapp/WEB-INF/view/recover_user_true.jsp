...
<h3>Recover User ID</h3>
    <form>
		  ...
		  <div class="form-group">
            ...
            <input type="text" class="form-control" name="contact" placeholder="${contact}" readonly="readonly">
            <div class="form-group">
            <button type="submit" disabled="disabled" class="btn btn-success btn-lg btn-block">Search</button>	
        </div>
        </div>
        </form>
        <sf:form  action="validate" modelAttribute="forgotUserId" method="post">   
        <div class="form-group">
            <sf:label path="ans1">${que1}</sf:label>
            <sf:input path="ans1" class="form-control" name="ans1" placeholder="Answer" required="true"/>
            <sf:hidden path="contact" value="${contact}"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label style="color:red">${userId} </label>
        </div>
