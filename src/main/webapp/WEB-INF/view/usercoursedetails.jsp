...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
			...
			<div class="w3-half" style="padding: 25px 25px 25px 25px;">
				<ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
					...
					<li class="w3-light-grey w3-padding-24">
						...
						<a
						href="startLearning?skillId=${skill.skillId}">
							<button type="submit" class="w3-button w3-white w3-padding-large">Start Learning</button>
						...
						<a
						href="userAssessment?skillId=${skill.skillId}">
							<button type="submit" class="w3-button w3-white w3-padding-large">Assessment</button>
	...
	<div style="float: left;width: 100%;">
		<a href="user_feed?courseId=${xyz.courseId}">
				<button type="submit" name="submit" value="Feedback"
					class="w3-button w3-white w3-padding-large" style="width: 15%; margin-left: 40%;">
					<b>Feedback</b>
				</button>
			</a>
