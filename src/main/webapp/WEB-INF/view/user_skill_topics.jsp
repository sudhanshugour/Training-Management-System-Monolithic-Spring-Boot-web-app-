...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<h4 class="w3-padding-16">Enrolled Courses !</h4>
		<form action="adminAddTopic">
		...
		<form action="viewTopicDetails">
			<c:forEach var="topicList" items="${topicList}">
				<div style="padding: 25px 25px 25px 25px;">
					<button class="w3-button w3-white w3-padding-large" type="submit"
						name="topicId" value="${topicList.topicId}">
						<b>${topicList.topic}</b>
					</button>
				</div>
			</c:forEach>
