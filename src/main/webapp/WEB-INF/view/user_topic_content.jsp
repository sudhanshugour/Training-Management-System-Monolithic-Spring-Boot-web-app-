...
<%@page import="com.cognizant.repositories.TopicRepository"%>
<%@page
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<div class="scp-quizzes-data" style="padding-left: 4%;">
			...
			<iframe width="560" height="315"
				src="${topic1.url}" frameborder="0"
				allowfullscreen></iframe>
			<br>


			<form action="deleteTopic">
				<input type="hidden" name="topicId" value="${topic1.topicId}">
				<button type="submit" name="skillId" value="${topic1.skillId}"
