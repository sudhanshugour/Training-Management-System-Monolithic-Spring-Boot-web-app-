...
<h3>Recover Password</h3>
    <sf:form action="loadQuestion1" modelAttribute="contact" method="post">
		
		  <div class="form-group">
            <sf:label path="contact"> &nbsp;User Id </sf:label>
            <sf:input path="contact" class="form-control" name="contact" placeholder="User Id" message = "Invalid Email Id" required="true" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$" />
            <div class="form-group">
