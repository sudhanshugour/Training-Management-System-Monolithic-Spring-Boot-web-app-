...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<c:forEach var="p" items="${plist}">
			...
			<div
				class="w3-container w3-dark-grey w3-text-light-grey "
				style="margin-left: 4%; margin-top:3% ;margin-right: 4%; margin-bottom: 1px ;padding: 4px"
				id="about">
				<p style="margin: 2px;" >
					&nbsp;	UserId : ${p.userId}
					</p>

				<div class="w3-content w3-justify" style="max-width: 98%">

					
					<div class="w3-white">
						<div class="w3-container w3-padding-small  w3-white">
							<p style="margin-top: 2px;">${p.feedback}jjjjjjjjjjjjjjjjjjjjj jjjjjjjj jjjjjjjjjjjjjj jjjjjjjjj jjjjjjjjjjjjjjjj jjjjjjjjjjjjjjjjj</p>
						</div>
					</div>
