...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<h1 style="margin-left: 5%">${ skill.skillName} Assessment Result</h1>
      <h3 style="margin-left: 5%">${marks }/${totalMarks } = <%=""+(int)((int)request.getAttribute("marks")*100/(int)request.getAttribute("totalMarks") )%>%</h3>
		<form action="userAssessmentsList" style="margin-left: 25%;margin-right: 25%;">
					<button type="submit" style="margin-bottom:5px"
						class="w3-button w3-block w3-green"
						>Check Assessment Record</button><br><br><br>
						
			</form>
			<a href="user_feed?courseId=${course.courseId}">
				<button type="submit" name="submit" value="Feedback"
					class="w3-button w3-block w3-green" style="width: 50%; margin-left: 25%;">
					<b>Feedback</b>
				</button>
			</a>
